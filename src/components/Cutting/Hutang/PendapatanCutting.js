...
const [simulasi, setSimulasi] = useState({
  ...
  const fetchSimulasi = async (tukang_cutting_id, kurangiHutang, kurangiCashbon) => {
    ...
    console.log('Memanggil fetchSimulasi', { tukang_cutting_id, kurangiHutang, kurangiCashbon });  try {
   ...
   <div>
      ...
      <table className="penjahit-table">
          ...
          <tbody>
            {pendapatans
              .filter((pendapatan) =>
                pendapatan.tukang_cutting_id?.toString().toLowerCase().includes(searchTerm.toLowerCase())
              )
              .map((pendapatan) => (
                <tr key={pendapatan.tukang_cutting_id}>
                
                <td data-label="Id : ">{pendapatan.nama_tukang_cutting}</td>
    ...
    <div className="modal-content-hutang">
      ...
      <form onSubmit={handleTambahPendapatan} className="form-hutang">
        <div className="form-group-hutang">
          ...
          <input
            type="text"
            value={selectedCutting?.tukang_cutting_id || ''}
            readOnly
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            type="text"
            value={selectedCutting?.nama_tukang_cutting || ''}
            readOnly
          />
        </div>
